...
function Highlight<T extends React.ElementType = "div">({
  ...
  // Controlled when `value` is passed, otherwise local. Upstream kept ONE piece
  // of state and re-synced it from an effect on every `value` change, which is
  // a cascading render and leaves the highlight a frame behind its own prop.
  // Deriving it needs no effect and cannot drift.
